...
export default function AuthorAddForm() {
    const [name, setName] = useState("");
    const [piography, setPiography] = useState("");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axiosClient.post("/authors/create", authorData);
            setError({});
            window.location.href = "/admin/dashboard/authors?message=Registration successful";
        } catch (error) {
                ...
                <form onSubmit={handleSubmit} className="backdrop-blur-xl bg-white/60 shadow-xl rounded-3xl p-8 border border-gray-100">
                    <header className="flex justify-between items-center mb-8 border-b border-gray-100 pb-6">
                        <div>
                            ...
                            <p className="text-gray-500 mt-1">Create a new author profile</p>
                        </div>
                        <Link 
                    ...
                    <textarea
                        ...
                        name="piography"
                        value={piography}
                        onChange={(e) => setPiography(e.target.value)}
                                        rows="6"
                            ...
                            >
                                ...
                                {loading ? (
                                    <>
                                        ...
                                        <span className="ml-2">Adding Author...</span>
                                    </>
                                ) : (
                                    <>
