...
const CategoryEditForm = ({ onSubmit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
        const response = await axiosClient.put(`/categories/${categoryId}`, formData);
        if (onSubmit) {
            onSubmit(response.data);
        }
        navigate(`/admin/dashboard/categories?message=Category updated successfully`);
    } catch (error) {
                            ...
                            >
                                ...
                                {loading ? (
                                    <>
                                        ...
                                        <span className="ml-2">Updating Category...</span>
                                    </>
                                ) : (
                                    <>
